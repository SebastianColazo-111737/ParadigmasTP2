...
public class GwentTest {
    ...
    public void unJugadorPuedeJugarUnaCartaDeSuManoEnUnaSeccionElegida(){
        ...
        assertFalse(manoJ1.getCartas().contains(cartaElegida)); //el jugador ya no tiene la carta en la mano
        assertTrue(asedioJ1.getUnidadesColocadas().contains(cartaElegida)); // la Unidad ahora esta en la seccion
