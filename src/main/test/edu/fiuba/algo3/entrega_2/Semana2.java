...
// import edu.fiuba.algo3.clases.Tipos.Asedio;
// import edu.fiuba.algo3.clases.Tipos.CuerpoACuerpo;
// import edu.fiuba.algo3.clases.Tipos.Distancia;
//
...
// this.cartaMock12 = new Unidad("Catapulta", 8, new Asedio(), new Unidas());
...
// //Se
// // ve que no esta contando el indice de esta...
// this.cartaMock20 = new Unidad("Arquero", 4, new Distancia(), null);
// this.cartaMock21 = new Unidad("Guerrero", 6, new CuerpoACuerpo(), null);
//
...
// cartaMock16, cartaMock17, cartaMock18, cartaMock19, cartaMock20,
// cartaMock21));
//
...
// cartasMock2.add(new Unidad(unidad.getName(), unidad.obtenerPuntosBase(),
// unidad.getTipo(), null));
// }
// }
// }
...
//
// // Act
// juego.jugarCarta(jugador2, cartaUnidad1, Posicion.CUERPO_A_CUERPO); // <--
// esta deberia ir al descarte
...
//
// // Assert
// assertEquals(2, jugador2.getDescarte().getCantCartasEnPila()); // 2 cartas en
// descarte: cartaUnidad1 +
// // cartaTierraArrasada
// assertEquals(0, juego.cantidadCartasEnSeccion(jugador2,
// Posicion.CUERPO_A_CUERPO));
// }
//
// @Test
...
// Unidad cartaAgil = new Unidad("hechizero", 10, Posicion.A_DISTANCIA, new
// Agil());
// Boolean seJugoCartaAgil = false;
//
// // Act
// seJugoCartaAgil = jugador1.jugarCarta(cartaAgil, tablero,
// Posicion.CUERPO_A_CUERPO);
//
// // Assert
 ...
 * cartaMedico.revivirCarta(jugador1,cartaUnidad1, Posicion.A_DISTANCIA,
 * juego.getTablero());
 * 
 * // Assert
 * assertEquals(1, juego.cantidadCartasEnSeccion(jugador1,
 * Posicion.A_DISTANCIA));
 * assertEquals(1, jugador1.getDescarte().getCantCartasEnPila()); //Aca deberia
 * estar ahora el medico
 * }
 */
// }
